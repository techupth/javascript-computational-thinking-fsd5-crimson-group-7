...
for (let i = 0; i < orders.length; i++) {
  if (orders[i].productPrice > bestPrice) {
    bestPrice = orders[i].productPrice;
    nameBestPrice = orders[i].productName;
  }
}
console.log(`The most expensive product in orders: ${nameBestPrice}`);
